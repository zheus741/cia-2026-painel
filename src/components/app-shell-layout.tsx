...
const ADMIN_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Modalidades',        href: '/admin/modalidades',            icon: Medal },
      { label: 'Resultados Ext.',    href: '/esportivo/resultados-externos', icon: Globe },
      { label: 'Importar Resultados', href: '/esportivo/importar-resultados', icon: FileSpreadsheet },
    ],
  },
  {
    label: 'Operacional',
    items: [
      ...
      { label: 'Redes Sociais',  href: '/redes',              icon: Share2 },
