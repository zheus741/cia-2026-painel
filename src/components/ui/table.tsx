...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('[&_tr]:border-b border-[var(--border)]', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-3 text-left align-middle font-medium text-[var(--muted-foreground)] text-xs uppercase tracking-wider',
      className,
    )}
    {...props}
  />
